...
const CheckoutDetails = ({ setModal }) => {
  ...
  return (
    <div>
      {successMsg ? (<div className='flex flex-col justify-center items-center h-[100vh] lg:h-[600px] px-6 '>
      ...
      <div className='lg:gap-x-8 h-full lg:px-12 lg:py-8 '>
        ...
        <div className='h-[86vh] lg:h-[47.5vh] flex flex-col lg:flex-row gap-x-4 '>
          {/* box 1*/}
          ...
          >
            <div className='border rounded-lg flex flex-col mb-4 p-4 h-full '>
              <h3 className='text-base font-extrabold uppercase mb-4 border-b pb-4 '>Your oder </h3>
              {/* items */}
              <div className='overflow-y-scroll overflow-hidden scrollbar-thin scrollbar-thumb-gray-200 
            ...
            {/*place order btn */}
            <button onClick={() => setSuccessMsg(true)} 
